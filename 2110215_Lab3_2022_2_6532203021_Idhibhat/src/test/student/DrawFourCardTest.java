...
public class DrawFourCardTest {
	...
	void testPlay() {
		...
		for (int i = 0; i < 16; i++)
			gameInstance.getDeck().add(new NumberCard(CardColor.randomColor(), CardSymbol.randomSymbol()));
		gameInstance.getPlayerHand(0).add(c2);
		gameInstance.getPlayerHand(1).add(new DrawFourCard());
		gameInstance.getPlayerHand(1).add(c3);
		gameInstance.getPlayerHand(2).add(new DrawFourCard());
		gameInstance.getPlayerHand(2).add(new NumberCard(CardColor.BLUE, CardSymbol.ONE));
		gameInstance.getPlayerHand(3).add(new DrawFourCard());
